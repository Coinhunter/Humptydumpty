...
describe('GeoapiService', () => {
  ...
  it('should contain more than 30 entries for "Skara" - 532.',
    async(inject([HttpClientModule, GeoapiService], (http: HttpClientModule, service: GeoapiService) => {
  ...
  it('should throw an error when supplying too short filter',
    async(inject([HttpClientModule, GeoapiService], (http: HttpClientModule, service: GeoapiService) => {
